declare module 'datedash' {
	...
	// Math Days
	export function addDays(date: Date | string | number, days: number, format?: string): string
	export function subtractDays(date: Date | string | number, days: number, format?: string): string
