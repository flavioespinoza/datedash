...
describe('date format options', () => {
    ...
    it(`format 'full' should return 'Mon Jan 07 2019 00:00:00 GMT-0700 (Mountain Standard Time)'`, function(done) {
...
describe('date format undefined', function() {
    it('format `undefined` should return `01/07/2019`', function(done) {
        assert.strictEqual(date(any_date), '01/07/2019')
        done()
    })

    it('format `null` should return `01/07/2019`', function(done) {
        assert.strictEqual(date(any_date, null), '01/07/2019')
        done()
    })

    it('format `foo` should return `01/07/2019`', function(done) {
        assert.strictEqual(date(any_date, 'foo'), '01/07/2019')
        done()
    })

    it('format `8` should return `01/07/2019`', function(done) {
