		...
		return /* html */`
			<html class="docs gr__Datedash_com" style="overflow: auto;">
				<head>
					...
					<title>datedash</title>
					<meta name="viewport" content="width=device-width, initial-scale=1" />
					<link rel="stylesheet" type="text/css" href="assets/css/main.css" />
					<script src="assets/js/boot.js" async></script>
					<script src="vendor/Datedash/Datedash.min.js"></script>
					<script src="https://embed.runkit.com/" async></script>
					...
					<noscript>
						<link href="https://cdn.jsdelivr.net/fontawesome/4.7.0/css/font-awesome.min.css rel=stylesheet crossorigin integrity=sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" />
					</noscript>
					...
					<header>
						<div class="container">
								<div class="header-section logo-section">
										<div class="logo">
												<a href="/" title="Datedash">Datedash</a>
										</div>
								...
								<div class="header-section">
										<a href="doc/doc" class="btn primary">Documentation</a>
								</div>
						</div>
					</header>
					<div class="doc-main">
